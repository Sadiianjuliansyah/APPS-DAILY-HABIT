...
document.addEventListener("DOMContentLoaded", () => {
    const Storage = window.DailyHabitStorage;
    ...
    function initialize() {
        if (!Storage) {
            alert("Sistem penyimpanan Daily Habit gagal dimuat.");
            return;
        }
        ...
        // Tombol PIN disembunyikan pada Portfolio Edition.
        if (elements.lockButton) {
            elements.lockButton.classList.add("is-hidden");
        }

        // Fitur ganti PIN juga disembunyikan pada Portfolio Edition.
        if (elements.changePinButton) {
            elements.changePinButton
    ...
    function exportApplicationData() {
        ...
        downloadLink.download =
            `daily-habit-backup-${formatDateKey(
                new Date()
            )}.json`;
    ...
    function confirmDeleteAllData() {
        openConfirmModal({
            ...
            action: () => {
                ...
                showToast(
                    "Seluruh data Daily Habit telah dihapus."
                );
            }
        });
    }
    ...
    window.addEventListener("load", () => {
        navigator.serviceWorker
            ...
            .then((registration) => {
                ...
                console.log(
                    "Daily Habit siap digunakan secara offline."
                );
            })
            .catch((error) => {
                console.error(
