...
window.DailyHabitStorage = (() => {
    const STORAGE_KEY = "daily_habit_portfolio_data_v1";
    ...
    function loadData() {
        ...
        try {
            ...
            console.error("Data Daily Habit gagal dibaca:", error);
            return saveData(createDefaultData());
        }
    }
    ...
    function createExportPayload() {
        return {
            application: "Daily Habit",
            format: "daily-habit-backup",
            version: DATA_VERSION,
    ...
    function importData(payload) {
        ...
        if (
            ...
            throw new Error(
                "File bukan cadangan data Daily Habit."
            );
        }
